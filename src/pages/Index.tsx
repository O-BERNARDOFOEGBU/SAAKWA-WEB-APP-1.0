              ...
              <div className="container mx-auto px-4 py-16 sm:py-24">
                <div className="text-center">
                  ...
                  <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
                    Premium laundry service from Osapa to VI, Marina & Heart of
                    Lekki.
              ...
              <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  ...
                  <Card className="text-center hover:shadow-lg transition-shadow">
                    ...
                    <CardContent>
                      <CardDescription className="text-gray-600">
                        Door-to-door service from VI, Marina, and Heart of
                        Lekki. Schedule pickup and delivery at your convenience.
                      </CardDescription>
                    </CardContent>
                  </Card>
            ...
            <div className="py-16 bg-blue-600">
              <div className="container mx-auto px-4 text-center">
                ...
                <p className="text-xl text-blue-100 mb-8">
                  Join hundreds of satisfied customers in VI, Marina & Heart of
                  Lekki
                </p>
                <Button
                  size="lg"
